...
// una card che rimanda a se stessa è solo un giro a vuoto. Per la stessa ragione
...
// Griglia allineata a quella di TriesteVillas, non a quella di
// TriesteImmobiliare: TSI ha sostituito Martino con Paolo Isotti perché Paolo
// presidia QUEL marchio (decisione di Martino, 2026-07-30). FriuliVillas è un
// marchio di gruppo, quindi qui torna Martino. Le email sono caselle personali
// reali: non sono il contatto del sito, che resta richieste@triestevillas.com.
const TEAM = [
