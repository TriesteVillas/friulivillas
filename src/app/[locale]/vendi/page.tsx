...
// `zeroProvvigione` NON c'è, ed è la differenza sostanziale con la pagina di
// TriesteImmobiliare da cui questa discende: "0% al venditore entro settembre
// 2026" e "−25% se ricompri con noi" sono condizioni commerciali DI QUEL
// marchio, con una scadenza. Ricopiarle qui avrebbe pubblicato su un altro sito
// un impegno che nessuno ha preso per FriuliVillas. Se e quando ci sarà
// un'offerta analoga, si rimette il blocco (e i suoi due badge) con i suoi
// termini veri.
const BLOCKS = [
  "velocita", "mandatoSemplice", "checkup", "materiale",
