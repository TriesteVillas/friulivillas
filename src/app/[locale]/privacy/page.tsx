...
const CONTROLLER =
  ...
  "Email richieste@triestevillas.com · PEC milou@pec.emailc.it";
...
const CONTENT: Record<string, Content> = {
  it: {
    ...
    sections: [
      ...
      {
        h: "8. I tuoi diritti",
        p: "Puoi esercitare in qualsiasi momento i diritti di accesso, rettifica, cancellazione, limitazione, opposizione e portabilità, oltre a revocare il consenso, scrivendo a richieste@triestevillas.com. Hai inoltre diritto di proporre reclamo al Garante per la protezione dei dati personali.",
      },
      {
        h: "9. Cookie",
  ...
  en: {
    ...
    sections: [
      ...
      {
        h: "8. Your rights",
        p: "You may at any time exercise the rights of access, rectification, erasure, restriction, objection and portability, and withdraw consent, by writing to richieste@triestevillas.com. You also have the right to lodge a complaint with the Italian Data Protection Authority.",
      },
      {
        h: "9. Cookies",
  ...
  de: {
    ...
    sections: [
      ...
      {
        h: "8. Ihre Rechte",
        p: "Sie können jederzeit die Rechte auf Auskunft, Berichtigung, Löschung, Einschränkung, Widerspruch und Datenübertragbarkeit ausüben sowie Ihre Einwilligung widerrufen, indem Sie an richieste@triestevillas.com schreiben. Zudem haben Sie das Recht, Beschwerde bei der italienischen Datenschutzbehörde einzulegen.",
      },
      {
        h: "9. Cookies",
