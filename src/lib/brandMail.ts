...
// FriuliVillas non ha profili social propri: la lista è vuota di proposito
// (il footer salta il blocco quando non c'è nulla da mostrare).
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width:600px;width:100%">
      <tr><td style="background:${BRAND_DARK};border-radius:14px 14px 0 0;padding:30px 32px 26px" align="center">
        <a href="${SITE}/${lang}" target="_blank" style="text-decoration:none">
          <img src="${SITE}/brand/logo-email.png" width="230" alt="friulivillas" style="display:block;border:0;max-width:80%;height:auto;margin:0 auto;font-family:${FONT};font-size:22px;font-weight:600;letter-spacing:.04em;color:#ffffff" />
          <span style="display:block;margin-top:12px;font-family:${FONT};font-size:10px;letter-spacing:.34em;text-transform:uppercase;color:${ACCENT}">Friuli&nbsp;Venezia&nbsp;Giulia&nbsp;·&nbsp;Italia</span>
        </a>
      </td></tr>
      ...
      <tr><td style="background:${BRAND_DARK};border-radius:0 0 14px 14px;padding:24px 34px 28px" align="center">
        ${social ? `<p style="margin:0 0 13px">${social}</p>` : ""}
        <p style="margin:0;font-family:${FONT};font-size:12px;color:${ON_DARK_MUTED}">
          <a href="${SITE}" target="_blank" style="color:${ON_DARK};text-decoration:none;font-weight:600">friulivillas.com</a>
